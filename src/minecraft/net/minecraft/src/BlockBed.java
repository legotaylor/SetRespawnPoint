			...
			if(!world1.worldProvider.canRespawnHere()) {
				...
				if(enumStatus15 == EnumStatus.OK) {
					...
					if(enumStatus15 == EnumStatus.NOT_POSSIBLE_NOW) {
                        ...
                        ChunkCoordinates bedChunkCoordinates = new ChunkCoordinates(MathHelper.floor_double(i2), MathHelper.floor_double(i3), MathHelper.floor_double(i4));
                        entityPlayer5.setPlayerSpawnCoordinate(bedChunkCoordinates);
					}
